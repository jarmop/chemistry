...
type Molecule = Molecules[number];
...
function getMolecule() {
  ...
  moleculeData.connections.forEach((connection) => {
    const atom = createBall(connection.atom.radius, connection.atom.color);
    atom.position.copy(
